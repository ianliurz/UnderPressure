...
# Create a dataframe
df <- tibble(
  Country = c("Ireland", "Italy", "Greece", "Sweden"),
  ManifestoDisimilarityOne = c(ir_1_2, ita_1_2, gre_1_2, swe_1_2),
  ManifestoDisimilarityTwo = c(ir_2_3, ita_2_3, gre_2_3, swe_2_3),
)
